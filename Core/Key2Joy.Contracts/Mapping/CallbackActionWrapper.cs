...
/// </summary>
public class CallbackActionWrapper : MarshalByRefObject
{
    private readonly object instance;

    public CallbackActionWrapper(object instance) => this.instance = instance;
    ...
    public CallbackAction AsCallbackAction() => this.AsDelegateInvoke;
}
